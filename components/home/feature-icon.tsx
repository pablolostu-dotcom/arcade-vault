// ===== components/home/feature-icon.tsx =====
// Portado de FeatureIcon() de references/templates/home-about/home.jsx, rect por
// rect. Iconos pixel de 16x16 dibujados con rects; el color lo hereda de la
// tarjeta vía currentColor. Sin estado ni interacción: Server Component.

/** Los cuatro iconos de las feature cards del home. */
...
export function FeatureIcon({ kind }: { kind: FeatureIconKind }) {
  ...
  // ROCKET es el único que queda: la unión de arriba hace innecesario el
  // return null con el que cierra el prototipo.
  return (
    <svg className="ft-icon" viewBox="0 0 16 16"><g fill={C}>
